...
Usage:
    python scripts/version.py patch        # 2.0.0 → 2.0.1
    python scripts/version.py minor        # 2.0.0 → 2.1.0
    python scripts/version.py major        # 2.0.0 → 3.0.0
    python scripts/version.py 2.1.0        # explicit version
"""
...
def bump(current: str, kind: str) -> str:
    # Explicit version passed — use as-is
