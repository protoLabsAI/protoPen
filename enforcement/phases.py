...
TOOL_PHASE_MAP: dict[str, KillChainPhase] = {
    ...
    # ── gRPC Audit ──
    "grpc_reflection": KillChainPhase.ENUMERATION,
    "grpc_describe": KillChainPhase.ENUMERATION,
    "grpc_call": KillChainPhase.ENUMERATION,
    "grpc_fuzz": KillChainPhase.VULN_ASSESSMENT,
    "grpc_auth_test": KillChainPhase.VULN_ASSESSMENT,
    "grpc_tls_check": KillChainPhase.ENUMERATION,
    "grpc_web_test": KillChainPhase.ENUMERATION,
    "protoscan": KillChainPhase.ENUMERATION,
    # ── SPA Test ──
    "route_bypass": KillChainPhase.VULN_ASSESSMENT,
    "state_inspect": KillChainPhase.VULN_ASSESSMENT,
    "postmessage_scan": KillChainPhase.VULN_ASSESSMENT,
    "token_leakage_audit": KillChainPhase.VULN_ASSESSMENT,
    "dom_xss_scan": KillChainPhase.VULN_ASSESSMENT,
    "js_source_map_check": KillChainPhase.ENUMERATION,
    # ── Credential Attack ──
    "responder": KillChainPhase.ENUMERATION,
    "crackmapexec_enum": KillChainPhase.ENUMERATION,
    "crackmapexec_spray": KillChainPhase.EXPLOITATION,
    "crackmapexec_pth": KillChainPhase.LATERAL_MOVEMENT,
    "ntlm_relay": KillChainPhase.EXPLOITATION,
    # ── Active Directory ──
    "bloodhound_collect": KillChainPhase.ENUMERATION,
    "bloodhound_edges": KillChainPhase.ENUMERATION,
    "certipy_find": KillChainPhase.ENUMERATION,
    "certipy_vuln": KillChainPhase.VULN_ASSESSMENT,
    "certipy_req": KillChainPhase.EXPLOITATION,
    "enum4linux_ng": KillChainPhase.ENUMERATION,
    "ldapsearch": KillChainPhase.ENUMERATION,
    "kerberoast": KillChainPhase.EXPLOITATION,
    "asreproast": KillChainPhase.EXPLOITATION,
    "secretsdump": KillChainPhase.POST_EXPLOITATION,
    # ── IoT Audit ──
