...
LOCALSTORAGE_PATTERNS = [
    (
        re.compile(
            r"""localStorage\.setItem\s*\(\s*['"`]([^'"`]*(?:token|auth|jwt|access|refresh|bearer|session)[^'"`]*?)['"`]""",
            re.IGNORECASE,
        ),
        "localStorage",
        "write",
    ...
    (
        re.compile(
            r"""localStorage\.getItem\s*\(\s*['"`]([^'"`]*(?:token|auth|jwt|access|refresh|bearer|session)[^'"`]*?)['"`]""",
            re.IGNORECASE,
        ),
        "localStorage",
        "read",
    ...
    (
        re.compile(
            r"""sessionStorage\.setItem\s*\(\s*['"`]([^'"`]*(?:token|auth|jwt|session|bearer)[^'"`]*?)['"`]""",
            re.IGNORECASE,
        ),
        "sessionStorage",
        "write",
    ...
    (
        re.compile(
            r"""sessionStorage\.getItem\s*\(\s*['"`]([^'"`]*(?:token|auth|jwt|session|bearer)[^'"`]*?)['"`]""",
            re.IGNORECASE,
        ),
        "sessionStorage",
        "read",
    ...
    (
        re.compile(
            r"""localStorage\[['"`]([^'"`]*(?:token|auth|jwt|access|refresh)[^'"`]*?)['"`]\]\s*=""", re.IGNORECASE
        ),
        "localStorage",
        "write",
    ),
