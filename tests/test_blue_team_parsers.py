...
class TestCisAuditParsers:
    def test_ssh_audit_with_issues(self, store):
        ...
        raw = json.dumps({
            ...
            "checks_run": 5,
            "issues": [
                {"severity": "high", "check": "PasswordAuthentication", "value": "yes",
                 "recommendation": "Set to no"},
                {"severity": "critical", "check": "PermitEmptyPasswords", "value": "yes",
                 "recommendation": "Set to no"},
            ],
            "pass_count": 3,
            "fail_count": 2,
    ...
    def test_tls_audit_weak_cipher(self, store):
        ...
        raw = json.dumps({
            ...
            "protocol": "TLSv1.2",
            "issues": [{"severity": "high", "check": "Cipher Strength", "value": "RC4 (40 bits)",
...
class TestNetMonitorParsers:
    def test_traffic_baseline(self, store):
        ...
        raw = json.dumps({
            "interface": "eth0", "duration_sec": 30,
            "packet_count": 1500, "total_bytes": 200000,
            "top_hosts": {"10.0.0.1": 500}, "top_ports": {"443": 800},
        })
...
class TestHardeningCheckParser:
    def test_failed_checks_only(self, store):
        ...
        raw = json.dumps({
            ...
            "total_checks": 8, "passed": 5, "failed": 3,
            "checks": [
                {"check": "PermitRootLogin", "passed": False, "severity": "critical",
                 "expected": "no", "actual": "yes", "remediation": "Set PermitRootLogin no"},
                {"check": "MaxAuthTries", "passed": True, "severity": "medium"},
                {"check": "PasswordAuthentication", "passed": False, "severity": "high",
                 "expected": "no", "actual": "yes", "remediation": "Set PasswordAuthentication no"},
                {"check": "X11Forwarding", "passed": False, "severity": "medium",
                 "expected": "no", "actual": "yes", "remediation": "Set X11Forwarding no"},
            ],
        })
    ...
    def test_all_passed(self, store):
        from tools.parsers.hardening_check import parse_hardening
        raw = json.dumps({
            "service": "nginx", "total_checks": 3, "passed": 3, "failed": 0,
            "checks": [
...
class TestIrToolkitParsers:
    ...
    def test_ioc_scan_findings(self, store):
        ...
        raw = json.dumps({
            "findings": [
                {"ioc_type": "ip", "ioc_value": "198.51.100.1", "file": "/var/log/syslog", "line": 42,
                 "context": "connection from 198.51.100.1"},
                {"ioc_type": "domain", "ioc_value": "evil.com", "file": "/var/log/dns.log", "line": 99,
