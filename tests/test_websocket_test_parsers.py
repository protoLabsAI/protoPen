...
class TestParseWsAuthBypass:
    def test_vulnerable(self, store):
        raw = json.dumps({
            "url": "ws://target:8080",
            "tests": [
                {"test": "no_auth_connect", "vulnerable": True,
                 "severity": "high", "detail": "Server accepted unauthenticated connection"},
            ],
        })
    ...
    def test_not_vulnerable(self, store):
        raw = json.dumps({
            "url": "ws://target:8080",
            "tests": [
                {"test": "no_auth_connect", "vulnerable": False,
                 "severity": "info", "detail": "Connection rejected"},
            ],
        })
        entities = parse_ws_auth_bypass(raw, store)
        assert entities == []
...
class TestParseWsCswsh:
    def test_vulnerable_origins(self, store):
        raw = json.dumps({
            "url": "ws://target:8080",
            "tests": [
                {"test": "cswsh", "origin": "https://evil.com",
                 "vulnerable": True, "severity": "high",
                 "detail": "Evil origin accepted"},
                {"test": "cswsh", "origin": "null",
                 "vulnerable": True, "severity": "high",
                 "detail": "Null origin accepted"},
                {"test": "cswsh", "origin": "https://attacker.example.com",
...
class TestParseWsInjection:
    def test_reflected_payload(self, store):
        raw = json.dumps({
            "url": "ws://target:8080",
            "tests": [
                {"test": "injection", "category": "sqli",
                 "payload": "' OR '1'='1", "reflected": True,
                 "error_leak": False, "severity": "high",
    ...
    def test_error_leak(self, store):
        raw = json.dumps({
            ...
            "tests": [
                {"test": "injection", "category": "sqli",
                 "payload": "1; DROP TABLE", "reflected": False,
                 "error_leak": True, "severity": "medium",
    ...
    def test_no_findings(self, store):
        raw = json.dumps({
            "url": "ws://t",
            "tests": [
                {"test": "injection", "category": "xss",
                 "payload": "<script>", "reflected": False,
                 "error_leak": False, "severity": "info"},
            ],
        })
