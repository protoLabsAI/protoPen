...
// (the Home rail's background-streaming dot) re-render only when the boolean
// flips — not on every streamed token. Drives the "a turn is progressing while
// you're on another rail" indicator.
const _anyStreaming = () =>
